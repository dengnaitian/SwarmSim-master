...
model.nbStates = 20;   % Number of states in the GMM
model.nbVar =8; % Number of variables [gp.predictt,x1,x2,.. vx1,vx2...]
model.dt = 0.01;     % Time step duration
% nbData = demo_dura/model.dt; % Length of each trajectory
nbData = 230;
model = init_GMM_distanceBased(Data, model);
[model,gamma2,~] = EM_GMM(Data, model);

gmr_input = data_demo(1:5,:) ;
[DataOut, SigmaOut,H] = GMR(model, gmr_input, 1:5, 6:model.nbVar); %see Eq. (17)-(19)
